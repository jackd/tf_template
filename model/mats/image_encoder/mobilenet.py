"""
Hack of tf.keras.applications.MobileNet-containing file.

Removes an error check that allows for non-square inputs. Won't work if
`include_top` is True and input is not square. Also won't work if first element
of input shape isn't one of the allowed.
"""
